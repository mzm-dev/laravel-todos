<div>
    <x-modal name="taskCreateModal" :show="$errors->isNotEmpty()" focusable>
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <x-select-input wire:model="category_id" class="w-full border rounded px-3 py-2">
                ...
                <div class="card-footer p-4 bg-gray-100 border-t border-gray-200 mt-6 flex justify-end">
                    ...
                    <x-success-button  x-on:click="watingSaveTask()" class="ms-1">
