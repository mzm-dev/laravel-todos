<div>
    <x-modal name="categoryCreateModal" :escapeClose="false" maxWidth="md" :show="$errors->isNotEmpty()" focusable>
        <div class="card bg-white rounded-lg shadow-md overflow-hidden">
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div class="card-footer p-4 bg-gray-100 border-t border-gray-200 mt-6 flex justify-end">
                    ...
                    <x-success-button x-on:click="watingSaveCategory()" class="ms-1">
