<div>
    <x-modal name="categoryEditModal{{ $category->id }}" :escapeClose="false" maxWidth="md" :show="$errors->isNotEmpty()" focusable>
            ...
            <form wire:submit.prevent="update" class="space-y-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <x-select-input wire:model="is_active" class="w-full border rounded px-3 py-2">
                            <option value>-- Pilih Kategori --</option>
                            @foreach (['Tidak Aktif','Aktif'] as $key => $val)
                ...
                <div class="card-footer p-4 bg-gray-100 border-t border-gray-200 mt-6 flex justify-end">
                    ...
                    <x-success-button x-on:click="watingUpdateCategory()" class="ms-1">
